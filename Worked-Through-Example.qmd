...
[![Figure 5.5 from "Data Visualization: From Theory to Practice" by James Baglin. Accessed March 22nd, 2025.](Images/Coordinates_Data Visualization Bookdown Figure 5.5.png)](https://dark-star-161610.appspot.com/secured/_book/grammar-and-vocabulary.html#coord)
...
You can find more about `plotly` and the kinds of interactive plots it can generate with `ggplot()` objections in their documentaion: [Plotly R Open Source Graphing Library](https://plotly.com/r/) and [Plotly ggplot2 Open Source Graphing Library](https://plotly.com/ggplot2/).
