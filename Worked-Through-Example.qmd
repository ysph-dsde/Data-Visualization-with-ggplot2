...
Download the complete slide deck with annotations and the in-person workshop handout. Comments were saved in the bottom left of each slide.
...
-   **MMWRyear**, **MMWRweek**, **MMWRday** - the year, week, and day of the entry in Morbidity and Mortality Weekly Report (MMWR) format. MMWR is the standard epidemiologic week assigned by National Notifiable Diseases Surveillance System (NNDSS) in their disease reports ([MMWR Definition](https://ndc.services.cdc.gov/wp-content/uploads/MMWR_week_overview.pdf)).
